...
public class FrameWord extends javax.swing.JFrame {
    ...
    public FrameWord() {
        ...
        defaultTableModel.addColumn("Vietnamese");
        for(Word s: test.dictionaryManagement.Dic.ListWord){
            defaultTableModel.addRow(new Object[] {s.word_target,s.word_explain});
        }
    }
    ...
    private void initComponents() {
        ...
        list.setRowMargin(0);
        list.setSelectionBackground(new java.awt.Color(102, 153, 255));
        ...
        jPanel2.setBackground(new java.awt.Color(131, 188, 243));

        jLabel1.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication1/Image/icons8_list_48px.png"))); // NOI18N
